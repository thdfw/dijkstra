...
class DParams():
    ...
    def __init__(self) -> None:
        ...
        self.storage_volume = config.getfloat('parameters', 'STORAGE_VOLUME_GALLONS')
        self.max_hp_elec_in = config.getfloat('parameters', 'HP_MAX_ELEC_POWER_KW')
        self.min_hp_elec_in = config.getfloat('parameters', 'HP_MIN_ELEC_POWER_KW')
        self.initial_top_temp = config.getfloat('parameters', 'INITIAL_TOP_TEMP_F')
        self.initial_thermocline = config.getfloat('parameters', 'INITIAL_THERMOCLINE')
        self.storage_losses_percent = config.getfloat('parameters','STORAGE_LOSSES_PERCENT')
